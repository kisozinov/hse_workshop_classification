...
# this part need to work locally on my windows machine, mb it should be deleted
import sys
sys.path.insert(0, 'E:/GitHub/hse_workshop_classification/src')

from utils import save_as_pickle
from data.preprocess import preprocess_data, preprocess_target, extract_target, drop_unnecesary_id
